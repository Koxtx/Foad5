...
getRecentMedia(`${BASE_URL}${search2}?api_key=${API_KEY}&language=fr-FR&page=1`);
...
getComingMedia(`${BASE_URL}${search3}?api_key=${API_KEY}&language=fr-FR&page=1`);
...
getPopularTv(`${BASE_URL}${searchtv3}?api_key=${API_KEY}&language=fr-FR&page=1`);
